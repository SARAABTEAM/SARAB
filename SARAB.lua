...
send(msg.chat_id_, msg.id_,'▫️⁝  عدد الكروبات الان » { '..#group..' }'..SARABk..''..SARAB..'\n▫️⁝  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if SARAB1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ▫️⁝ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ▫️⁝ '..SARAB1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ▫️⁝ العضو : {["..data.first_name_.."](T.ME/Yp1_7)}\n ▫️⁝ ["..SARAB_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ▫️⁝ عذرا » {["..data.first_name_.."](T.ME/Yp1_7)}\n ▫️⁝ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝗦𝗥━━━━━━≫
 ▫️⁝ ↬𝑆𝐴𝑅𝐴b 𝑇𝐸𝐴𝑀
≪━━━━━━𝗦𝗥━━━━━━≫
 ▫️⁝ ↬[Channel SARAB](t.me/Yp1_7) 
≪━━━━━━𝗦𝗥━━━━━━≫
 ▫️⁝ ↬[Information](t.me/M8llu)
≪━━━━━━𝗦𝗥━━━━━━≫
 ▫️⁝ ↬[DEVELOPER](t.me/Yp1_2)
≪━━━━━━𝗦𝗥━━━━━━≫
 ▫️⁝ ↬[To talk to us](t.me/Amr19_Bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ▫️⁝ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ▫️⁝ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ▫️⁝ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Yp1_7')..') \n ▫️⁝ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ▫️⁝ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
status  = '\n ▫️⁝ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ▫️⁝ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ▫️⁝ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Yp1_7')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ▫️⁝ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Yp1_7')..')'..'\n ▫️⁝ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_, t..'ٴ▫️⁝ٴ≪━━━━━━𝗦𝗥━━━━━━≫ٴ▫️⁝○ٴ\n▫️⁝ 彡 .[𝑆𝐴𝑅𝐴b 𝑇𝐸𝐴𝑀](t.me/Yp1_7)➢ ')
end
